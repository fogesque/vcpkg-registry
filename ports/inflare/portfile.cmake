...
case "$1" in
  ...
  elseif(DEFINED ENV{CI_JOB_TOKEN} AND NOT "$ENV{CI_JOB_TOKEN}" STREQUAL "")
    set(_inflare_auth "JOB-TOKEN: $ENV{CI_JOB_TOKEN}")
  else()
    message(FATAL_ERROR
      "inflare: no credentials available. Set INFLARE_GITHUB_TOKEN (GitHub) "
      "or GITLAB_PAT / CI_JOB_TOKEN (GitLab) before building.")
  endif()
